                    ...
                    <form action="{{ route('supplier.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="phone" type="text" name="phone" :value="old('phone')" required class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <select id="status" name="status" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                    <option value="active" {{ old('status') == 'active' ? 'selected' : '' }}>{{ __('supplier.status_active') }}</option>
                                    <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>{{ __('supplier.status_inactive') }}</option>
                                </select>
